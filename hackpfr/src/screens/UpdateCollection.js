    ...
    componentDidMount() {
        this.setState({
            data: collections.features.map((item) => {
                return { id: item.properties.id, name: item.properties.name, organizer: item.properties.organizer, created: item.properties.created, fraction: item.properties.fraction, amount: item.properties.amount, action: <><Button variant="primary" onClick={() => this.handleEdit(item.properties.id)}><FontAwesomeIcon icon={faPen} /></Button> <Button variant="danger" onClick={() => this.handleDelete(item.properties.id)}><FontAwesomeIcon icon={faTimesCircle} /></Button></> }
            })
        });
    }
                    ...
                    <Modal.Body>
                        <Form>
                            <Form.Group controlId="formBasicEmail">
                                ...
                                <Form.Control type="email" placeholder="Wprowadź ilość zebranych zasobów" ref={this.textBoxRef} />
                                <Form.Text className="text-muted">Wartość ta zostanie wysłana do urzędu oraz zapisana w rankingach.</Form.Text>
                            </Form.Group>
                        </Form>
                    </Modal.Body>
                    <Modal.Footer>
