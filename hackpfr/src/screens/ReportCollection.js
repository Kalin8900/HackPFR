...
import { faMapMarker, faCheckCircle } from '@fortawesome/free-solid-svg-icons'
                            ...
                            <Container>
                                <Form>
                                    ...
                                    <Form.Group controlId="formBasicEmail">
                                        ...
                                        <Form.Control type="email" placeholder="Wprowadź nazwę zbiórki" />
                                    </Form.Group>
                                    <Form.Group controlId="formBasicEmail">
                                        <Form.Label>Organizator</Form.Label>
                                        <Form.Control type="email" placeholder="Wprowadź organizatora" />
                                    </Form.Group>
                                    <Form.Group controlId="formBasicEmail">
                                        <Form.Label>Frakcje</Form.Label>
                                        <Select isMulti={true} isSearchable={true} value={fraction} placeholder={"Wybierz frakcje..."} options={fractions} onChange={setFraction} noOptionsMessage={() => "Nie znaleziono frakcji"} />
                                        <Form.Text className="text-muted">Wybierz wszystkie zbierane frakcje.</Form.Text>
                                    </Form.Group>
                                    <Form.Group controlId="formBasicEmail">
